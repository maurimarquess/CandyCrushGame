...
const int PUNTS_INIT_X = 295;
const int PUNTS_INIT_Y = 40;

// Posició a pantalla on imprimir el nº de moviments
const int MOVIMENTS_INIT_X = 295;
const int MOVIMENTS_INIT_Y = 75;

// Posició a pantalla on imprimir els objectius aconseguits
const int OBJECTIU_INIT_X = 540;
const int OBJECTIU_INIT_Y = 40;
