...
, m_oFontCandy(getFontPath(FONT_CANDY).c_str(),30,NFont::Color(0,0,0,255))
{
                                       ...
                                       const string& msg)
{
    switch (name) {
        ...
        case FONT_WHITE_30:
            ...
            break;
        case FONT_CANDY:
            return m_oFontCandy.draw(posX, posY, NFont::Scale(size), "%s", msg.c_str());
...
string GraphicManager::getImagePath(IMAGE_NAME name){
    ...
    switch (name) {
        ...
        case IMAGE_PIECE_PURPLE_HORIZONTAL:
            ...
            break;
        case IMAGE_VICTORY:
            path = "data/Graphics/Has_guanyat.png";
            break;
        case IMAGE_LOOSE:
            path = "data/Graphics/Has_perdut.png";
            break;
        default:
            path = "";
            break;
...
string GraphicManager::getFontPath(FONT_NAME name){
    ...
    switch (name) {
        ...
        case FONT_WHITE_30:
            ...
            break;
        case FONT_CANDY:
            path = "data/Fonts/CandyCrush.ttf";
            break;
        default:
            path = "";
            break;
